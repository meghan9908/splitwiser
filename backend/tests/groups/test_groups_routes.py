...
class TestGroupsRoutes:
    ...
    @pytest.mark.asyncio
    async def test_create_group_success(self, async_client: AsyncClient, auth_headers, mock_db):
        ...
        with patch("app.groups.service.group_service.create_group") as mock_create:
            ...
            response = await async_client.post("/groups", json=group_data, headers=auth_headers)
    ...
    @pytest.mark.asyncio
    async def test_create_group_empty_name(self, async_client: AsyncClient, auth_headers, mock_db):
    ...
    @pytest.mark.asyncio
    async def test_list_user_groups(self, async_client: AsyncClient, auth_headers, mock_db):
    ...
    @pytest.mark.asyncio
    async def test_get_group_details(self, async_client: AsyncClient, auth_headers, mock_db):
        ...
        with patch("app.groups.service.group_service.get_group_by_id") as mock_get:
            ...
            response = await async_client.get(f"/groups/{group_id}", headers=auth_headers)
    ...
    @pytest.mark.asyncio
    async def test_get_group_not_found(self, async_client: AsyncClient, auth_headers, mock_db):
    ...
    @pytest.mark.asyncio
    async def test_update_group_metadata(self, async_client: AsyncClient, auth_headers, mock_db):
        ...
        with patch("app.groups.service.group_service.update_group") as mock_update:
            ...
            response = await async_client.patch(f"/groups/{group_id}", json=update_data, headers=auth_headers)
    ...
    async def test_delete_group(self, async_client: AsyncClient, auth_headers, mock_db):
        ...
        with patch("app.groups.service.group_service.delete_group") as mock_delete:
            ...
            response = await async_client.delete(f"/groups/{group_id}", headers=auth_headers)
    ...
    @pytest.mark.asyncio
    async def test_join_group_by_code(self, async_client: AsyncClient, auth_headers, mock_db):
        ...
        with patch("app.groups.service.group_service.join_group_by_code") as mock_join:
            ...
            response = await async_client.post("/groups/join", json=join_data, headers=auth_headers)
    ...
    async def test_leave_group(self, async_client: AsyncClient, auth_headers, mock_db):
        ...
        with patch("app.groups.service.group_service.leave_group") as mock_leave:
            ...
            response = await async_client.post(f"/groups/{group_id}/leave", headers=auth_headers)
    ...
    @pytest.mark.asyncio
    async def test_get_group_members(self, async_client: AsyncClient, auth_headers, mock_db):
        ...
        with patch("app.groups.service.group_service.get_group_members") as mock_get_members:
            ...
            response = await async_client.get(f"/groups/{group_id}/members", headers=auth_headers)
    ...
    @pytest.mark.asyncio
    async def test_update_member_role(self, async_client: AsyncClient, auth_headers, mock_db):
    ...
    @pytest.mark.asyncio
    async def test_remove_member(self, async_client: AsyncClient, auth_headers, mock_db):
        ...
        with patch("app.groups.service.group_service.remove_member") as mock_remove:
            ...
            response = await async_client.delete(f"/groups/{group_id}/members/{member_id}", headers=auth_headers)
